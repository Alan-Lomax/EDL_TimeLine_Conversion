...
> Click the button “Import EDL”. A standard windows dialog will open so you can find the file and click on it. Once done an excel power query will read and parse the EDL file and drop the resulting data into your worksheet.
